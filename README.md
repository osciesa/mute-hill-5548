...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/mute-hill-5548
```

A live public deployment of this template is available at [https://mute-hill-5548.templates.workers.dev](https://mute-hill-5548.templates.workers.dev)
